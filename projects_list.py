...
projects_list = [
    ...
    Project(
        ...
        '',
        'https://github.com/pctablet505/MIT-6.86x-2021-feb/tree/main/Project1/sentiment_analysis'
    ...
    Project(
        ...
        '',
        'https://github.com/pctablet505/MIT-6.86x-2021-feb/tree/main/Project2/mnist/part1'
    ...
    Project(
        ...
        '',
        'https://github.com/pctablet505/MIT-6.86x-2021-feb/tree/main/Project2/mnist/part2-twodigit'
    ...
    Project(
        ...
        '',
        'https://github.com/pctablet505/MIT-6.86x-2021-feb/tree/main/project4/resources_netflix/netflix'
    ),
    Project(
        ...
        '',
        'https://github.com/pctablet505/MIT-6.86x-2021-feb/tree/main/project5/rl'
    ),
    Project(
        "Maze Solver",
        '''Demonstration of complexity of different search algorithms ''',
        '',
        'https://github.com/pctablet505/CS50-AI'
    ),
    Project(
        'Degrees',
        ...
        'https://github.com/pctablet505/CS50-AI/tree/main/degrees'
    ...
    Project(
        ...
        'https://github.com/pctablet505/CS50-AI/tree/main/tictactoe'
    ...
    Project(
        ...
        'https://github.com/pctablet505/CS50-AI/tree/main/minesweeper'
    ),
    Project(
        ...
        'https://github.com/pctablet505/CS50-AI/tree/main/crossword'
    ),
    Project(
    ...
    Project(
        ...
        'https://github.com/pctablet505/CS50-AI/tree/main/traffic'
